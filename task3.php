<?php  include "tasks/task2/checkConvex.php";  ?>
<div class="container">
    <div class="main">
        <div class="content">
            <div class="section">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="padding-left:10px">
                            ...
                            <input style="font-weight:bold" type="button" value="Draw Polygon"
                                   onclick="drawPolygon();"/>
                            <input style="font-weight:bold" type="button" value="Make convex hull"
...
<script src="tasks/task3/basicDraw.js" type="text/javascript">
</script>
